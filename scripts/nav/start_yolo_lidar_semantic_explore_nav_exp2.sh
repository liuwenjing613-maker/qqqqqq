...
echo "  ros2 topic echo /explore_state_json   (data.summary = 重点摘要: active_sector/exhaust/selected)"
echo "  ros2 topic echo /nav_state            (data.action_explanation = 转/走/停原因)"
echo "  Foxglove Raw Messages panels:"
echo "    RawMessages!explore_summary (/explore_state_json: summary 段在最前)"
echo "    RawMessages!nav_state       (完整 nav 状态快照)"
