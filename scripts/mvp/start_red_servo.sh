...
# CAMERA_DEV=/dev/video8 CHASSIS_PORT=/dev/ttyUSB0 ./scripts/mvp/start_red_servo.sh
# ============================================================
...
if [ ! -e "$CHASSIS_PORT" ]; then
  ...
  echo "  CHASSIS_PORT=/dev/myserial ./scripts/mvp/start_red_servo.sh"
  exit 1
fi
...
echo "停止完整链路："
echo "   cd $PROJECT_DIR"
echo "   ./scripts/mvp/stop_red_servo.sh"
echo "============================================================"
